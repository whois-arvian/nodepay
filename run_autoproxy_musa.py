...
# Static token
STATIC_TOKEN = "eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiIxMjg3NzEyNDM1NTUzMTczNTA0IiwiaWF0IjoxNzMxNTEwMTkzLCJleHAiOjE3MzI3MTk3OTN9.vpT1ycGGpsZbmXxXvThdq4lST8lhiB7V-Oy96iTs_uFUIyoduq1ouSKfF3NTJdw4JXA8HWnhoV5UqNjW6GqHsw"  # Replace with your static token
...
async def main():
    ...
    if r.status_code == 200:
        with open('auto_proxies_musa.txt', 'wb') as f:
            for chunk in r:
                f.write(chunk)
    all_proxies = load_proxies('auto_proxies_musa.txt')
